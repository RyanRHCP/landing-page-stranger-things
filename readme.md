...
- Landing page totalmente responsiva (desktop, tablet e mobile)
- Animações avançadas utilizando **GSAP (GreenSock Animation Platform)**
...
1. Clone este repositório:
   ```bash
   git clone https://github.com/RyanRHCP/landing-page-stranger-things.git